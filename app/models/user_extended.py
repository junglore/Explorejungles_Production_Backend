"""
Extended User model with rewards system integration
"""
...
class User(Base):
    ...
    # Performance indexes for currency queries
    __table_args__ = (
        Index('idx_users_points_balance', 'points_balance'),
        Index('idx_users_credits_balance', 'credits_balance'),
        Index('idx_users_total_points', 'total_points_earned'),
    )

    def __repr__(self):
        return f"<User(id={self.id}, email={self.email}, username={self.username}, points={self.points_balance})>"
